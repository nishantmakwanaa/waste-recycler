...
export default function ReportPage() {
  ...
  const calculateEstimatedPrice = (wasteType: string, quantity: string) => {
    const amount = parseFloat(quantity);
    const pricePerUnit = dummyPriceData[wasteType.toLowerCase() as keyof typeof dummyPriceData] || 0;
